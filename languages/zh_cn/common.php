...
//手机版
$_LANG['label_mobile_category_title'] = '商品分类';
$_LANG['label_mobile_button_search'] = '商品搜寻';
$_LANG['label_mobile_promotion_title'] = '本 月 促 销';
$_LANG['label_mobile_new_title'] = '最 新 上 架';
$_LANG['label_mobile_hot_title'] = '热 销 商 品';
$_LANG['label_mobile_best_title'] = '本 月 主 打';
$_LANG['label_mobile_user_center'] = '会员中心';
$_LANG['label_mobile_user_register'] = '加入会员';
$_LANG['label_mobile_user_login'] = '登入';
$_LANG['label_mobile_user_logout'] = '登出';
$_LANG['mobile_copyright'] = $GLOBALS['_CFG']['shop_name'] . " 版权所有<br />&copy; " . date('Y') . " All Rights Reserved.";

$_LANG['message_board_js']['msg_username_empty'] = '请填写会员帐号';
$_LANG['message_board_js']['msg_username_length'] = '会员帐号需大於3个字元';
$_LANG['message_board_js']['msg_password_empty'] = '请填写会员密码';
$_LANG['message_board_js']['msg_password_length'] = '会员密码需大於6个字元';
$_LANG['message_board_js']['msg_password_notmatch'] = '会员密码两次输入不一致';
$_LANG['message_board_js']['msg_sel_question_empty'] = '请选择一个密码提示问题';
$_LANG['message_board_js']['msg_passwd_answer_empty'] = '请填写密码提示解答';
$_LANG['message_board_js']['msg_extend_field5i_empty'] = '请填写手机号码';
$_LANG['message_board_js']['msg_extend_field5i_error'] = '手机号码只能是数字或连字号(-)';
?>